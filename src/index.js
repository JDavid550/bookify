...
var keywordResponsive = document.getElementById('keywordResponsive');
let submitResponsive = document.getElementById('submitResponsive');
...
const searchwithClick = (button,word)=>{
